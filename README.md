...
| Client   | Resizable/fixed/fullscreen host, logical rendering and presentation, verified bootstrap content, retail TGA/DXT3 sprite paths, native text configuration/encoding/font resolution/rasterization/layout, atlas management, batching, and OpenGL text rendering                                                                                                                                                              | First runtime UI/text consumer, networking, gameplay, map/role/effect/animation integration, and other higher-level rendering                                                       |
